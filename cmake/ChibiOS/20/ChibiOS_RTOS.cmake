...
FOREACH (FAMILY F1 F2 F3 F4 F7)
    SET (CHIBIOS_SOURCES_${CHIBIOS_KERNEL}_${FAMILY}
        ...
        # todo: move shell to separate cmake component
        os/various/shell/shell.c
        os/various/shell/shell_cmd.c

        # todo: move rt_test to separate cmake component
        test/lib/ch_test.c
...
SET (CHIBIOS_SOURCES_${CHIBIOS_KERNEL}_HEAP       os/oslib/src/chmemheaps.c)
